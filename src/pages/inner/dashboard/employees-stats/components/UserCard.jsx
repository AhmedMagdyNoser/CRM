...
export default function EmployeeCard({ user }) {
  return (
    <button className="flex animate-fade-in-fast flex-col items-center gap-5 rounded-xl border border-transparent bg-gray-100 px-4 py-10 shadow-sm transition-colors hover:border-gray-300 hover:bg-gray-50 hover:shadow sm:gap-8">
